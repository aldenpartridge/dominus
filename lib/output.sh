...
This reconnaissance scan was performed using TROXXER v2.0 against the target domain **$DOMAIN**.
...
<body>
    <div class="container">
        <h1>🔍 TROXXER Reconnaissance Report</h1>
